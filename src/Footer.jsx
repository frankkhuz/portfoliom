    ...
    <footer className="text-white p-6 bg-[#6B7280] mt-8 w-full">
      <div className="flex flex-col lg:flex-row justify-around items-center h-auto lg:h-32 lg:space-x-8">
        ...
        <div className="flex flex-col items-start mb-6 lg:mb-0 lg:w-1/3">
          ...
          <div className="flex sm:flex-row lg:flex-col sm:space-x-6 lg:space-x-0 space-y-4 lg:space-y-4 sm:space-y-0 items-center justify-between border border-black">
            {/* Email */}
            <a
              href="mailto:frankkhuzy@gmail.com"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center text-xs sm:text-sm lg:text-base border border-black"
            >
            ...
            {/* Contact */}
            <div className="flex items-center text-xs sm:text-sm lg:text-base border border-black">
              <img
                src={contact}
                alt="contact"
